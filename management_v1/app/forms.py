...
class LoginForm(Form):
    ...
    def validate(self):
        if not Form.validate(self):
            self.submit.errors.append("ENTER login and password")
            return False
        ...
        if User.exists(user_name, user_pass):
            ...
            self.submit.errors.append("Invalid login or password")
            return False


class ContConfigForm(Form):
    """

    """
    check = BooleanField('Publish to the public internet')
